...
@section("content")
        <form action="{{ route('order.checkout.post', $order->id) }}" method="POST">
            ...
            <div class="grid md:grid-cols-2 sm:grid-cols-1 pb-3"><div class="mt-2">
                    <div class="flex rounded-md bg-white shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600">
                ...
                <div class="flex rounded-md bg-white shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-indigo-600 mt-2">
                    <label for="ExpDate" class="flex font-bold select-none items-center pl-3 text-gray-500 sm:text-sm">Expiration Date</label>
                    <input type="text" required pattern="[0-9][0-9]/[0-9][0-9]" minlength="5" maxlength="5" name="ExpDate" id="ExpDate" class="block flex-1 invalid:border-pink-400 invalid:text-red-600 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6" placeholder="Experation Date">
                </div>
                <div class="flex rounded-md bg-white shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-indigo-600 mt-2">
