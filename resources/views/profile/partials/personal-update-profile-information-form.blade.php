                ...
                <div class="grid md:grid-cols-3 md:gap-4 sm:grid-cols-1">
                    <div class="mt-2">
                        <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600">
                            ...
                            <input type="text" name="AddressLine2" value="{{$user->AddressLine2}}" id="Price" class="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6" placeholder="AddressLine2">
                        </div>
                    </div>
                    <div class="mt-2">
                        <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600">
                            <label for="Town" class="flex font-bold select-none items-center pl-3 text-gray-500 sm:text-sm">Town:</label>
                            <input type="text" name="Town" value="{{$user->Town}}" id="Stock" class="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6" placeholder="Town">
                        </div>
                    </div>
                    <div class="mt-2">
                        <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600">
                            <label for="PostCode" class="flex font-bold select-none items-center pl-3 text-gray-500 sm:text-sm">PostCode:</label>
                            <input type="text" name="PostCode" value="{{$user->PostCode}}" id="Barcode" class="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6" placeholder="PostCode">
                        </div>
                    </div>
                </div>
            </div>
