        ...
        <div class="md:pr-20">
                <div class="mt-2">
                    <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600">
                        ...
                        <input type="text" required name="Name" id="Name" class="block flex-1 invalid:border-pink-400 invalid:text-red-600 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6" placeholder="Product Name">
                    </div>
                </div>
            ...
            <div class="grid md:grid-cols-3 md:gap-4 sm:grid-cols-1">
                <div class="mt-2">
                    <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600">
                        ...
                        <input type="number" step="0.01" pattern="[0-9]*.[0-9][0-9]" min="0" name="Price" id="Price" class="block flex-1 invalid:border-pink-400 invalid:text-red-600 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6" placeholder="1.00">
                    </div>
                </div>
                <div class="mt-2">
                    <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600">
                        <label for="Stock" class="flex font-bold select-none items-center pl-3 text-gray-500 sm:text-sm">*Stock:</label>
                        <input type="number" min="0" required name="Stock" id="Stock" class="block flex-1 invalid:border-pink-400 invalid:text-red-600 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6" placeholder="0">
                    </div>
                </div>
                <div class="mt-2">
                    <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600">
                ...
                <div class="border-gray-900/10">
                    <div class="mt-2">
                        <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600">
                            ...
                            <input type="number" min="0" max="100" name="Discount" id="Discount" class="block flex-1 invalid:border-pink-400 invalid:text-red-600 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6" placeholder="10">
                        </div>
                    </div>
                </div>
            </div>
