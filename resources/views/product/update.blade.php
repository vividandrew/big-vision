        ...
        <div class="grid md:grid-cols-2 sm:grid-cols-1 pb-3">
            <div class="md:pr-20">
                ...
                <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-indigo-600 mt-2">
                    ...
                    <textarea id="Description" name="Description" rows="4" class="block bg-transparent w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">{{$product->Description}}</textarea>
                </div>
            </div>
                ...
                <div class="grid md:grid-cols-3 md:gap-4 sm:grid-cols-1">
                    ...
                    <div class="mt-2">
                        <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600">
                            ...
                            <input type="text" name="Barcode" value="{{$product->Barcode}}" id="Barcode" class="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6" placeholder="03164941">
                        </div>
                    </div>
                    <div class="mt-2">
                        <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600">
                            <label for="Platform" class="flex font-bold select-none items-center pl-3 text-gray-500 sm:text-sm">Platform:</label>
                            <input type="text" name="Platform" value="{{$product->Platform}}" id="Platform" class="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6" placeholder="Xbox">
                        </div>
                    </div>
                ...
                <div class="w-full border-gray-900/10 pb-3">
                    <div class="mt-2">
                        <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600">
                            ...
                            <input type="text" name="ImageUrl" value="{{$product->ImageUrl}}" id="ImageUrl" class="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6" placeholder="/image/temp.png">
                        </div>
                    </div>
                </div>
            </div>
