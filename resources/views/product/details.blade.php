            ...
            <div class="m-2">
                <form id="userLogout" method="POST" action="{{ route('order.product', $product->id) }}">
                    ...
                    <div class="grid grid-cols-1">
                        <div class="mb-5" >
                            <input type="number" name="Quantity" id="Quantity" class="bg-gray-50 border border-gray-300 w-20 text-gray-900 block text-sm rounded-lg p-2.5" placeholder="1" value="1" required />
                        </div>
                        <div>
